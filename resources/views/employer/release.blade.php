            ...
            <div class="col">
                ...
                <div class="container">
                    ...
                    @if(count($laptops)>0)
                        ...
                        <ul>
                            @foreach($laptops as $laptop)
                                <li>
                                    <div class="row justify-content-md-start ml-2 mt-1">
                                        <div class="col-md-auto">
                                            <h3>
                            ...
                            @foreach($desktops as $desktop)
                                <li>
                                    <div class="row justify-content-md-start ml-2 mt-1">
                                        ...
                                        <div class="col-md-auto">
                                            <h3>
                                                <strong>Vc: </strong>VC{{$desktop->desktop->vc}}D
                                            </h3>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <div class="row justify-content-md-start mt-4">
                        <div class="col-md-auto">
                            <h3>
                                <strong style="text-underline: black" class="fa-underline">Comptes utilisateurs: </strong>
                            </h3>
                        </div>
                    </div>
                    <div class="row justify-content-md-start mt-1">
